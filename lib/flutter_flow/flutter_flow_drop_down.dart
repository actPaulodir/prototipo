...
class FlutterFlowDropDown<T> extends StatefulWidget {
  const FlutterFlowDropDown({
    ...
    this.isMultiSelect = false,
          ...
          isMultiSelect ? (controller == null && onChanged == null && multiSelectController != null && onMultiSelectChanged != null) : (controller != null && onChanged != null && multiSelectController == null && onMultiSelectChanged == null),
        );
...
class _FlutterFlowDropDownState<T> extends State<FlutterFlowDropDown<T>> {
  ...
  bool _useDropdown2() => widget.isMultiSelect || widget.isSearchable || !widget.isOverButton || widget.maxHeight != null;
      ...
      selectedItemBuilder: (context) => widget.options
          .map(
            (item) => Align(
              ...
              child: Text(
                isMultiSelect ? currentValues.where((v) => optionLabels.containsKey(v)).map((v) => optionLabels[v]).join(', ') : optionLabels[item]!,
                style: widget.textStyle,
                maxLines: 1,
              ),
            ),
